...
def FCN_Vgg16_32s(input_shape=None, weight_decay=0., batch_momentum=0.9, batch_shape=None, classes=7):
    ...
    x = ( Conv2D( classes ,  ( 1 , 1 ) ,activation='linear', padding='valid',kernel_initializer='he_normal'))(x)
...
if __name__ == '__main__':
    ...
    parser.add_argument( 'train_path', help='validation pic  directory', type=str)
    parser.add_argument( 'val_path', help='prediction masks directory', type=str)
