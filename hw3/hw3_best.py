...
if __name__ == '__main__':
    ...
    nums=[12]
    print('data loaded')
    model=get_file('vgg19_model-18-0.3909-improved-best1.h5','https://www.dropbox.com/s/l086opo2fjge6cz/vgg19_model-18-0.3909-improved-best1.h5?dl=1',cache_subdir='models')
    ...
    print('prediction of epoch{} is saved'.format(18))